...
def main():
    while True:
        ...
        list_send_user = [-1001380688773]
        if int(time_now) == 20 and check_insert_today_date is None: #додати перевірку на відправлене повідомлення в цей$            #data
